            ...
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <Grid container xs={12} justifyContent="space-between">
                  ...
                  <Grid item>
                    <FormControlLabel
                      ...
                      label="Show Detailed Bills"
                      onChange={(_, isChecked: boolean) => {
                        // Don't turn this off while some product filter is applied
                ...
                <Typography variant="body1">
                  Please specify the period to display the bills
                </Typography>
              </Grid>
              ...
              <Grid item xs={12}>
                <ButtonGroup>
                  <Button onClick={() => setRange("shift")}>Last Shift</Button>
